...
AQL-driven CLI and REPL for the Openwhyd SDK. Positional arguments are
...
./openwhyd-cli list authentication
./openwhyd-cli load 1 authentication
./openwhyd-cli load '{id:1}' authentication
