...
class GetUserPostEntity
  ...
  def make
    opts = @_entopts.dup
    GetUserPostEntity.new(@_client, opts)
  end
  ...
  # @return [GetUserPost, Hash] the current GetUserPost data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of GetUserPost fields)
  def match_get
  ...
  #
  # @param reqmatch [GetUserPostListMatch, Hash, nil] match filter (any subset of
  #   GetUserPost fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<GetUserPost>, Array] the matching GetUserPost items; raises OpenwhydError on failure
