...
module OpenwhydTestRunner
  ...
  def self.env_override(m)
    live = getenv("OPENWHYD_TEST_LIVE")
    override = getenv("OPENWHYD_TEST_OVERRIDE")
    ...
    explain = getenv("OPENWHYD_TEST_EXPLAIN")
    m["OPENWHYD_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = OpenwhydTestRunner
Helpers = OpenwhydHelpers
Vs = VoxgigStruct
