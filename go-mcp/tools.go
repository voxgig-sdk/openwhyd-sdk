...
type Args struct {
	Entity string         `json:"entity" jsonschema:"authentication | get_user_post | playlist | post | search | subscription | user"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.OpenwhydSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "openwhyd_list",
		Description: "List records from Openwhyd. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "openwhyd_load",
		Description: "Load a single record from Openwhyd. " +
...
func runOp(client *sdk.OpenwhydSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.OpenwhydSDK, name string) (sdk.OpenwhydEntity, error) {
