...
// Openwhyd SDK ratelimit feature
...
class OpenwhydRatelimitFeature extends OpenwhydBaseFeature
{
    ...
    private function _acquire(OpenwhydContext $ctx): void
    {
    ...
    private function _track(OpenwhydContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
