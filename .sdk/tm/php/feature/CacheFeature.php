...
class OpenwhydCacheFeature extends OpenwhydBaseFeature
{
    ...
    private function _through(OpenwhydContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
