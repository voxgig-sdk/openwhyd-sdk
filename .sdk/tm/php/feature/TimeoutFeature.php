...
class OpenwhydTimeoutFeature extends OpenwhydBaseFeature
{
    ...
    private function _with_timeout(OpenwhydContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(OpenwhydContext $_ctx, float $ms): void
    {
        $client = $this->client;
