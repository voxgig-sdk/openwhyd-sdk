...
class OpenwhydRbacFeature extends OpenwhydBaseFeature
{
    ...
    private function _required(OpenwhydContext $ctx): ?string
    {
    ...
    private function _reject(OpenwhydContext $ctx, string $required): void
    {
    ...
    private function _track(OpenwhydContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
