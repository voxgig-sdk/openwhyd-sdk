...
class OpenwhydProxyFeature extends OpenwhydBaseFeature
{
    ...
    public function init(OpenwhydContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (OpenwhydContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
