...
// Openwhyd SDK clienttrack feature
...
class OpenwhydClienttrackFeature extends OpenwhydBaseFeature
{
    ...
    public function PostConstruct(OpenwhydContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Openwhyd-SDK';
