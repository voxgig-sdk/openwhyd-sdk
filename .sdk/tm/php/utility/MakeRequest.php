...
// Openwhyd SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class OpenwhydMakeRequest
{
    public static function call(OpenwhydContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new OpenwhydResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new OpenwhydResponse($fetched);
        } else {
