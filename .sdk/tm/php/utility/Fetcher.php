...
// Openwhyd SDK utility: fetcher

class OpenwhydFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; OpenwhydSDK/1.0)';
    ...
    public static function call(OpenwhydContext $ctx, string $fullurl, array $fetchdef): array
    {
