...
from projectname_sdk.core.control import OpenwhydControl
...
class OpenwhydContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, OpenwhydResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, OpenwhydResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return OpenwhydError(code, msg, self)
