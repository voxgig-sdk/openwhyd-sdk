...
class OpenwhydTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = OpenwhydTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = OpenwhydTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = OpenwhydTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
