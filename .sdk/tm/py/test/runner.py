...
class OpenwhydTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = OpenwhydTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = OpenwhydTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = OpenwhydTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
