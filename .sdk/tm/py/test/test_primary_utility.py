...
from projectname_sdk import OpenwhydSDK
from projectname_sdk.core.spec import OpenwhydSpec
from projectname_sdk.core.result import OpenwhydResult
from projectname_sdk.core.response import OpenwhydResponse
from projectname_sdk.core.operation import OpenwhydOperation
from projectname_sdk.core.error import OpenwhydError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import OpenwhydBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = OpenwhydSDK.test(None, None)
        ...
        class TestInitFeature(OpenwhydBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(OpenwhydBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = OpenwhydSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = OpenwhydSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = OpenwhydSDK.test(None, setup_opts)
