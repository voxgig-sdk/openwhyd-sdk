...
|---|---|---|
| `ts/` | @voxgig-sdk/openwhyd-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/openwhyd-sdk \
      --repository voxgig-sdk/openwhyd-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/openwhyd-sdk` shows it, and
`npm trust revoke @voxgig-sdk/openwhyd-sdk --id=<id>` removes it.
