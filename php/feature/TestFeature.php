...
// Openwhyd SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class OpenwhydTestFeature extends OpenwhydBaseFeature
{
    ...
    public function init(OpenwhydContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (OpenwhydContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (OpenwhydContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(OpenwhydContext $ctx, $op, $args): array
    {
