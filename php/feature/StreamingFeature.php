...
// Openwhyd SDK streaming feature
...
class OpenwhydStreamingFeature extends OpenwhydBaseFeature
{
    ...
    private function _iterate(OpenwhydResult $result): \Generator
    {
    ...
    private function _streamable(OpenwhydContext $ctx): bool
    {
