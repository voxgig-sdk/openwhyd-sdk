...
The PHP SDK for the Openwhyd API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Authentication(null)->load(["id" => "example_id"], null);
...
```php
// Create
[$created, $_] = $client->Authentication(null)->create(["name" => "Example"], null);
...
[$result, $err] = $client->Openwhyd(null)->load(
    ["id" => "test01"], null
);
