...
class OpenwhydGraphql
{
    ...
    // equivalent.
    public static function body(OpenwhydContext $ctx): mixed
    {
    ...
    public static function errors(OpenwhydContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
