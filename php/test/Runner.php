...
class OpenwhydTestRunner
{
    ...
    {
        $live = self::getenv('OPENWHYD_TEST_LIVE');
        $override = self::getenv('OPENWHYD_TEST_OVERRIDE');
        ...
        $explain = self::getenv('OPENWHYD_TEST_EXPLAIN');
...
class_alias('OpenwhydTestRunner', 'Runner');
class_alias('OpenwhydHelpers', 'Helpers');
