...
// Openwhyd SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (OpenwhydSDK::test)
...
{
    private const SDK_CLASS = 'OpenwhydSDK';
    ...
    private const SDK_BASE = 'openwhyd_sdk';
