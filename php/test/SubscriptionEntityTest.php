...
class SubscriptionEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set OPENWHYD_TEST_SUBSCRIPTION_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function subscription_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("OPENWHYD_TEST_SUBSCRIPTION_ENTID");
