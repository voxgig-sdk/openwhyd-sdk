...
{
    public function test_direct_load_post(): void
    {
        $setup = post_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-post", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
