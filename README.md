...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/openwhyd` | `npm install @voxgig-sdk/openwhyd` |
| Python | `voxgig-sdk-openwhyd` | `pip install voxgig-sdk-openwhyd` |
| PHP | `voxgig-sdk/openwhyd` | `composer require voxgig-sdk/openwhyd` |
| Golang | `github.com/voxgig-sdk/openwhyd-sdk/go` | `go get github.com/voxgig-sdk/openwhyd-sdk/go` |
| Ruby | `voxgig-sdk-openwhyd` | `gem install voxgig-sdk-openwhyd` |
| Lua | `voxgig-sdk-openwhyd` | `luarocks install voxgig-sdk-openwhyd` |
