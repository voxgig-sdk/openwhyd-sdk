# Openwhyd SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions OpenwhydSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both OpenwhydSDK(...) and OpenwhydSDK.test(...) become
#      OpenwhydSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "openwhyd_sdk"
_SDK_CLASS = "OpenwhydSDK"
