...
from openwhyd_sdk.openwhyd_types import (
    Authentication,
...
class AuthenticationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AuthenticationEntity(self._client, opts)
    ...
    def data_get(self) -> Authentication:
    ...
    def match_get(self) -> Authentication:
    ...
    def create(self, reqdata: AuthenticationCreateData, ctrl=None) -> Authentication:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
