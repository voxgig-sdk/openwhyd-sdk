...
from openwhyd_sdk.utility import register

# Load features
from openwhyd_sdk.feature.base_feature import OpenwhydBaseFeature
from openwhyd_sdk.features import _has_feature, _make_feature
...
class OpenwhydSDK:
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("OpenwhydSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "OpenwhydSDK":
        if sdkopts is None:
            sdkopts = {}
