...
class GetUserPostEntity extends OpenwhydEntityBase_1.OpenwhydEntityBase {
    constructor(client, entopts) {
        ...
        this.name = 'get_user_post';
        this.name_ = 'get_user_post';
        this.Name = 'GetUserPost';
    }
    make() {
        return new GetUserPostEntity(this._client, this.entopts());
    }
...
exports.GetUserPostEntity = GetUserPostEntity;
//# sourceMappingURL=GetUserPostEntity.js.map