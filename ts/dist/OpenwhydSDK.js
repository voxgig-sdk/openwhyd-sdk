...
Object.defineProperty(exports, "OpenwhydEntityBase", { enumerable: true, get: function () { return OpenwhydEntityBase_1.OpenwhydEntityBase; } });
...
class OpenwhydSDK {
    ...
    async direct(fetchargs) {
        if (!this._options.allow.op.includes('direct')) {
            return {
                ok: false,
                err: new Error('OpenwhydSDK: direct: operation not allowed by' +
    ...
    async graphql(query, variables, ctrl) {
        ...
        if (!options.allow.op.includes('graphql')) {
            return {
                ok: false,
                err: new Error('OpenwhydSDK: graphql: operation not allowed by' +
        ...
        if (null != errors && Array.isArray(errors) && 0 < errors.length) {
            ...
            const err = new Error('OpenwhydSDK: graphql: ' +
    ...
    // Entity access: `client.GetUserPost().list()` / `client.GetUserPost().load({ id })`.
    // The argument is the entity OPTIONS object (passed to the entity
    // constructor as entopts), not initial entity data.
    GetUserPost(entopts) {
        const self = this;
...
exports.OpenwhydSDK = OpenwhydSDK;
const SDK = OpenwhydSDK;
exports.SDK = SDK;
//# sourceMappingURL=OpenwhydSDK.js.map