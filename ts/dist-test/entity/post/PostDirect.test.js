...
(0, node_test_1.describe)('PostDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-post', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-post', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["playlist_id01", "username01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['OPENWHYD_TEST_POST_ENTID'];
