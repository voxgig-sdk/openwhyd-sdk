...
(0, node_test_1.describe)('GetUserPostEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/get_user_post/GetUserPostTestData.json');
    ...
    let idmap = transform(['get_user_post01', 'get_user_post02', 'get_user_post03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=GetUserPostEntity.test.js.map