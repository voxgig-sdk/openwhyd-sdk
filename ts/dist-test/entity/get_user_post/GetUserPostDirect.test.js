...
(0, node_test_1.describe)('GetUserPostDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-get_user_post', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-get_user_post', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["get_user_post01"]))
            return;
...
function liveScenariosActive() { return false && process.env.OPENWHYD_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.OpenwhydSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.OPENWHYD_APIKEY,
        }));
        let idmap = env['OPENWHYD_TEST_GET_USER_POST_ENTID'];
    ...
    const client = new __1.OpenwhydSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GetUserPostDirect.test.js.map