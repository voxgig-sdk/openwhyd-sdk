...
function envOverride(m) {
    if ('TRUE' === process.env.OPENWHYD_TEST_LIVE ||
        'TRUE' === process.env.OPENWHYD_TEST_OVERRIDE) {
    ...
    m.OPENWHYD_TEST_EXPLAIN = process.env.OPENWHYD_TEST_EXPLAIN || m.OPENWHYD_TEST_EXPLAIN;
    return m;
}
