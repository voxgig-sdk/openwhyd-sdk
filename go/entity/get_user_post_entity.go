...
func NewGetUserPostEntity(client *core.OpenwhydSDK, entopts map[string]any) *GetUserPostEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetUserPostEntity) GetName() string { return e.name }
...
func (e *GetUserPostEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetUserPostEntity) Deleted() bool {
	return e.deleted
}


func (e *GetUserPostEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetUserPostEntity(e.client, opts)
}

func (e *GetUserPostEntity) Data(args ...any) any {
...
func (e *GetUserPostEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetUserPost; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetUserPostEntity) DataTyped(data ...GetUserPost) GetUserPost {
	if len(data) > 0 {
		return typedFrom[GetUserPost](e.Data(asMap(data[0])))
	}
	return typedFrom[GetUserPost](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetUserPost (all fields
// optional at the wire level).
func (e *GetUserPostEntity) MatchTyped(match ...GetUserPost) GetUserPost {
	if len(match) > 0 {
		return typedFrom[GetUserPost](e.Match(asMap(match[0])))
	}
	return typedFrom[GetUserPost](e.Match())
}
...
func (e *GetUserPostEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetUserPostEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *GetUserPostEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetUserPostListMatch and returns []GetUserPost. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *GetUserPostEntity) ListTyped(reqmatch GetUserPostListMatch, ctrl map[string]any) ([]GetUserPost, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[GetUserPost](res), nil
}



func (e *GetUserPostEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetUserPostEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetUserPostEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetUserPostEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
