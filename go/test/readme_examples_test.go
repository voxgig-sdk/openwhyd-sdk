...
const testSeed = `map[string]any{"entity": map[string]any{"authentication": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_user_post": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "playlist": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "post": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "search": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "subscription": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
