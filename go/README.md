...
The Golang SDK for the Openwhyd API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/openwhyd-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/openwhyd-sdk=../path/to/github.com/voxgig-sdk/openwhyd-sdk
```
...
```
github.com/voxgig-sdk/openwhyd-sdk/
...
The root package (`github.com/voxgig-sdk/openwhyd-sdk`) re-exports everything needed
