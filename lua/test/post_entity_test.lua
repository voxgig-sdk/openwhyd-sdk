...
describe("PostEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set OPENWHYD_TEST_POST_ENTID JSON to run live")
      return
    end
...
function post_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("OPENWHYD_TEST_POST_ENTID")
