...
describe("AuthenticationDirect", function()
  it("should direct-load-authentication", function()
    local setup = authentication_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-authentication", setup.live and "live" or "unit")
...
function authentication_direct_setup(mockres)
